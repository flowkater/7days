...
ActiveRecord::Schema.define(:version => 20130410103234) do
  ...
  add_index "todos", ["weekplan_id"], :name => "index_todos_on_weekplan_id"
  ...
  add_index "weekplans", ["user_id"], :name => "index_weekplans_on_user_id"
